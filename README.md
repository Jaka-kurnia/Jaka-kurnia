...
[![My Skills](https://skillicons.dev/icons?i=html,css,php,js,react,laravel,nextjs,tailwind,bootstrap,ts,go,flutter,dart,dotnet,)](https://skillicons.dev)


## Tools

[![My Skills](https://skillicons.dev/icons?i=vscode,androidstudio,mysql,visualstudio,postman,npm,docker,discord,figma,github,git)](https://skillicons.dev)
